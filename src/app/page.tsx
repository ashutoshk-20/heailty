    ...
    <div className='flex flex-col min-h-screen text-foreground overflow-hidden'>
      <section className="relative z-10 py-24 flex-grow">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative -top-10">
            {/* Corner decoration */}
            <div className="absolute -top-10 left-4 w-40 h-40 border-l-2 border-t-2" />
            
            {/* Left */}
            <div className="lg:col-span-7 space-y-8 relative left-5">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">
               ...
               {/* SEPERATOR LINE */}
              <div className="h-px w-2xl bg-gradient-to-r from-primary via-secondary to-primary opacity-50"></div>
            ...
            {/* Right */}
            <div className="lg:col-span-5 relative right-5">
              {/* CORNER PIECES */}
